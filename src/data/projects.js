...
import caveexploring from "../../public/images/projects/caveexploring.png";
import { SiReact, SiNextdotjs, SiTailwindcss, SiFigma, SiFirebase, SiPrettier, SiCplusplus, SiCmake } from "react-icons/si";
...
export const projects = [
    {
        ...
        description: "Developed a full-stack productivity dashboard that integrates Google Calendar, Weather, Spotify, and Time Zone Data, offering a centralized hub for daily tools.", 
    ...
    },
    {
        image: caveexploring, 
        name: "Cave Exploring",
        description: "A team-developed terminal-based game developed with C++, compiled through CMake, and tested with GoogleTest (gtest).", 
    ...
    },
    {
        ...
        icons: [SiReact, SiNextdotjs, SiTailwindcss, TbBrandFramerMotion],
