...
const ProjectLeft = ({ image, name, description, icons, github, website }) => {
    return (
        <div className="text-stanley-white-100 grid grid-cols-5 mx-[5%] gap-4 pb-[8vh]">
            <div className="col-span-5 md:col-span-2 border-1 border-stanley-purple-400">{image}</div>
            <div className="col-span-5 md:col-span-3 bg-stanley-purple-500 mb-8 mt-2 drop-shadow-projectleft flex flex-col relative h-[30vh] md:h-auto px-2 md:px-0">
                ...
                <div className="absolute bottom-0 inline-flex gap-2 pb-2 pl-3">{icons}</div>
